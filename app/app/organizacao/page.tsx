...
${fornecedores || "Nenhum fornecedor cadastrado."}`,
  ...
  function abrirEdicaoFornecedor(item: FornecedorEvento) {
    ...
    setNovoFornecedor({
      ...
      responsavel_nome: f?.responsavel_nome || (() => { const ct = tenantContatos.find((c) => c.id === f?.responsavel_tenant_contato_id); return ct?.nome || ""; })(),
      responsavel_telefone: f?.responsavel_telefone ? mascararTelefone(f.responsavel_telefone) : (() => { const ct = tenantContatos.find((c) => c.id === f?.responsavel_tenant_contato_id); return ct?.telefone ? mascararTelefone(ct.telefone) : ""; })(),
